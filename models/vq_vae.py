...
class SpectrogramDiscriminator(nn.Module):
    def __init__(self, input_channels=1, base_dim=32):
        ...
        self.conv1 = nn.Conv2d(input_channels, base_dim, kernel_size=5, stride=2, padding=2)
        self.conv2 = nn.Conv2d(base_dim, base_dim*2, kernel_size=5, stride=2, padding=2)
        self.conv3 = nn.Conv2d(base_dim*2, base_dim*4, kernel_size=5, stride=2, padding=2)
        self.conv4 = nn.Conv2d(base_dim*4, base_dim*8, kernel_size=5, stride=2, padding=2)
...
class SegmentVAE(nn.Module):
    def __init__(
        ...
        self.decoder = SegmentDecoder(
            ...
            input_channels=feature_channels*3, output_channels=1, base_dim = network_channel_base * 2
        )
