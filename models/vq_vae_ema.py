...
class VectorQuantizerEMA(nn.Module):
    ...
    def __init__(
        ...
        self.codebook = nn.Parameter(torch.zeros(num_codes, dim))
        # EMA buffers
    ...
    def forward(self, z_e: torch.Tensor) -> Tuple[torch.Tensor, torch.Tensor, torch.Tensor]:
        ...
        if self.training:
            ...
            self.codebook.data.lerp_(self.ema_w / n.unsqueeze(1), 0.00001)
...
class SegmentVQVAE(nn.Module):
    ...
    def forward(
        ...
        *,
        ...
        total   = recon_loss + vq_loss + 1e-2 * diversity_loss
